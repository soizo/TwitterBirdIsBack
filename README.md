...
恢复经典 Twitter 的蓝鸟图标、操作用语和蓝色按钮。原生 Manifest V3 扩展，无运行时依赖。
...
- `extension/locales.js` 负责语言解析，`extension/classic-locales.js` 保存可再生成的文案目录。覆盖状态、限制及官方来源见 [多语言核对记录](docs/localization.md)。
